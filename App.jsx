...
const RestaurantLoyaltyApp = () => {
  ...
  const RESTAURANTS = [
    ...
    { id: "north-bay-mazda", name: "North Bay Mazda", discount: 10 },
    {
      id: "lot-88",
      name: "Lot 88",
      discount: 20,
...
if (view === 'admin') {
  return (
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      {/* Main content - Conditionally show maintenance view or admin dashboard */}
      {showMaintenanceView ? (
        <MaintenanceManagement currentUser={currentUser} />
      ) : (
        <main className="flex-grow">
          {/* General Manager Management Component */}
